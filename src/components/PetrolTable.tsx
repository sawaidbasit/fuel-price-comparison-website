...
export default function PetrolTable({ data }: { data: FuelStation[] }) {
  ...
  <div className="border-2 border-green-700 w-full max-w-full">
      ...
      <table className="w-full table-fixed">
        <tbody>
          {filteredData?.map((station, index) => (
            <tr key={index} className="bg-green-600 text-white border-b border-[#383838]">
