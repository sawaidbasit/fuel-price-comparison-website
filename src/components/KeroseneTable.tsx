...
export default function KeroseneTable({ data }: { data: FuelStation[] }) {
  ...
  return (
    <div className="relative flex justify-center border-1">
      ...
      <div className="text-white absolute top-20 mr-24 max-w-[300px] px-4 z-20 text-center">
        <h3 className="text-xl font-semibold">Kerosene Price</h3>
      ...
      {/* <div className="absolute bottom-0 top-48 mr-20 z-30 w-full max-w-[80%]">
        <table className="w-full border-2 border-[#757575]">
          <thead>
            <tr className="bg-[#8d1f45] text-white">
          ...
          <tbody>
            {filteredData?.map((station, index) => (
              <tr className="bg-[#9b204b] text-white border-b border-[#383838]">
      ...
      <div className="absolute bottom-0 top-48 mr-20 z-30 w-full max-w-[80%]">
  <div className="border-2 bg-[#9b204b] w-full max-w-full">
    <table className="w-full border-[#757575] table-fixed">
      {/* Fixed Header */}
    ...
    <div className="h-[160px] overflow-y-auto custom-scrollbar w-full">
      <table className="w-full table-fixed">
        <tbody>
          {filteredData?.map((station, index) => (
            <tr key={index} className="bg-[#9b204b] text-white border-b border-[#383838]">
